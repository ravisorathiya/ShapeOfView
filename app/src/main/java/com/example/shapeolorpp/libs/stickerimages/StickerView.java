package com.example.shapeolorpp.libs.stickerimages;
...
public abstract class StickerView extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        this.iv_gone = new ImageView(context);

        this.iv_scale.setImageResource(R.drawable.zoom_sticker);
        this.iv_delete.setImageResource(R.drawable.delete_sticker);
        this.iv_flip.setImageResource(R.drawable.flip_sticker);
        this.iv_gone.setImageResource(R.drawable.close);
        ...
        LayoutParams iv_gone_params =
                new LayoutParams(
                        convertDpToPixel(BUTTON_SIZE_DP, getContext()),
                        convertDpToPixel(BUTTON_SIZE_DP, getContext())
                );
        iv_gone_params.gravity = Gravity.BOTTOM | Gravity.LEFT;
        ...
        this.addView(iv_gone, iv_gone_params);
...
//                        setControlItemsHidden(false);
    ...
    public void setControlItemsHidden(boolean isHidden) {
        if (isHidden) {
            ...
            iv_gone.setVisibility(View.INVISIBLE);
