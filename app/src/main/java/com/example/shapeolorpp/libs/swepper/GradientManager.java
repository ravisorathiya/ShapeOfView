package com.example.shapeolorpp.libs.swepper;
...
public class GradientManager {
    ...
    public SweepGradient getRandomSweepGradient() {
        ...
        */
        ...
        float val1 = mRandom.nextInt(mSize.x);
        float val2 =  mRandom.nextInt(mSize.y);
        Log.d(TAG, "getRandomSweepGradient: "+val1 + "sec is" + val2);
    ...
    private static final String TAG = "GradientManager";
}
